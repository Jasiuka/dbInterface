document.addEventListener("DOMContentLoaded", function () {
  ...
  pridejimas_select.addEventListener("change", (e) => {
    ...
    if (value === "reisai") {
      showInputs("reisai", visiPridejimoInputuBoxai);
    }
    if (value === "bagazai") {
      showInputs("bagazai", visiPridejimoInputuBoxai);
    }
    if (value === "registracijos") {
      showInputs("registracijos", visiPridejimoInputuBoxai);
    }
    if (value === "none") {
